...
class _$HomeStateImpl implements _HomeState {
  ...
  @override
  String toString() {
    return 'HomeState(isCameraPermissionGranted: $isCameraPermissionGranted, isMicrophonePermissionGranted: $isMicrophonePermissionGranted, status: $status)';
  }
  ...
  @override
  int get hashCode => Object.hash(runtimeType, isCameraPermissionGranted,
      isMicrophonePermissionGranted, status);
...
abstract class _HomeState implements HomeState {
  const factory _HomeState(
      {final bool isCameraPermissionGranted,
      final bool isMicrophonePermissionGranted,
      final StatsStatus status}) = _$HomeStateImpl;
